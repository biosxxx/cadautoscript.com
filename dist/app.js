...
const utilities = [
    {
        ...
        description: "Preview saddle intersections, tweak offsets, and export DXF templates ready for CNC plasma or waterjet tables.",
    ...
    },
    {
        ...
        description: "Calculate roll spacing, bending allowance, and developed lengths for EN 13445 / ASME VIII shells.",
    ...
    },
    {
        ...
        description: "Browse ISO metric, UNC, and UNF threads, check drill diameters, and copy callouts for drawings.",
    ...
    },
    {
        ...
        description: "Create serialized tags with logos, safety icons, QR codes, and export polished SVG/PNG plates for printing.",
...
const searchInput = document.querySelector("#utility-search");
const filterGroup = document.querySelector("#filter-group");
const formatLabel = (label) => label.charAt(0).toUpperCase() + label.slice(1);
const createCard = (utility) => {
...
const renderFilterGroup = () => {
    ...
    const categories = ["all", ...new Set(utilities.map((item) => item.category))];
...
const updateStats = () => {
    const statEl = document.querySelector('[data-stat="live-tools"]');
    if (statEl) {
